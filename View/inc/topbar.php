	...
	<nav class=" blue-grey lighten-1">
		<div class="container">
			<div class="nav-wrapper" >
				...
				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo padding-top:50px"><img src="../static/img/logo.png" width="90px" alt=""></a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<li><a href="<?=ROOT_URL?>blog_login.html" class="btn teal lighten-4 black-text waves-effect waves-light">Connexion<i class="material-icons right">lock_open</i></a></li>
					<?php endif ?>
					...
					<?php if (!empty($_SESSION['is_admin']) || !empty($_SESSION['is_user'])): ?>
					<li><a href="<?=ROOT_URL?>?p=blog&amp;a=logout" class="btn teal lighten-4 black-text waves-effect waves-light">Déconnexion<i class="material-icons right">lock_outline</i></a></li>
					<?php endif ?>
				</ul>
